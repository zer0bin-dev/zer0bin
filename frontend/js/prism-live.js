...
(async function() {
    ...
    var _ = Prism.Live = class PrismLive {
        constructor(source) {
            ...
            // this.syncScroll();
            this.textarea.addEventListener("scroll", this, {
                passive: true
            });
            ...
            this.source.dispatchEvent(new CustomEvent("prism-live-init", {
                bubbles: true,
                detail: this
            }));
        }
        ...
        setSelection(start, end) {
            ...
            if (this.selectionStart !== this.selectionEnd && (prevStart !== this.selectionStart || prevEnd !== this.selectionEnd)) {
                this.textarea.dispatchEvent(new Event("select", {
                    bubbles: true
                }));
            }
        }
        ...
        replace(text) {
            ...
            if (hadSelection) {
                ...
                this.setSelection({
                    start: this.selectionEnd - text.length
                });
            }
        }
        ...
        duplicateContent() {
            ...
            this.insert(text, {
                index: this.selectionStart - before.length
            });
        }
        ...
        static adjustIndentation(text, {
            indentation,
            relative = true,
            indent = _.DEFAULT_INDENT
        }) {
            if (!relative) {
